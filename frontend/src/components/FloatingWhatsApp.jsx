...
export default function FloatingWhatsApp() {
  ...
  const waLink =
    'https://wa.me/917067694391?text=Hi%20Xanvoraa%20Technologies!%20I%20want%20to%20discuss%20a%20project.'

  return (
    <div className={`fwa ${visible ? 'fwa--visible' : ''}`}>
      {/* Tooltip */}
      <div className={`fwa__tooltip ${showTooltip ? 'fwa__tooltip--show' : ''}`}>
        👋 Need a free consultation?
        <span className="fwa__tooltip-arrow" />
      </div>
      ...
      >
        {/* Pulse rings */}
        <span className="fwa__pulse" />
        <span className="fwa__pulse fwa__pulse--delay" />
